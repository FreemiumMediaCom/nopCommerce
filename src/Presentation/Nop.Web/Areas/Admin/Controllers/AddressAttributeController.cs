...
{
    public async partial class AddressAttributeController : BaseAdminController
    {
        #region Fields
        ...
        public async virtual Task<IActionResult> ListBlock()
        {
        ...
        [HttpPost]
        public async virtual Task<IActionResult> List(AddressAttributeSearchModel searchModel)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
        ...
        public async virtual Task<IActionResult> Create(AddressAttributeModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public async virtual Task<IActionResult> Edit(AddressAttributeModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost]
        public async virtual Task<IActionResult> ValueList(AddressAttributeValueSearchModel searchModel)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedDataTablesJson();
        ...
        public async virtual Task<IActionResult> ValueCreatePopup(int addressAttributeId)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost]
        public async virtual Task<IActionResult> ValueCreatePopup(AddressAttributeValueModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost]
        public async virtual Task<IActionResult> ValueEditPopup(AddressAttributeValueModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();

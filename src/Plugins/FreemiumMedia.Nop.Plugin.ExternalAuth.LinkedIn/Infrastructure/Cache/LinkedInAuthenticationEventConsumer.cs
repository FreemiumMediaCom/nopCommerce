...
namespace FreemiumMedia.Nop.Plugin.ExternalAuth.LinkedIn.Infrastructure.Cache
{
    /// <summary>
    /// LinkedIn authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class LinkedInAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public LinkedInAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(LinkedInAuthenticationDefaults.PROVIDER_SYSTEM_NAME))
                return;

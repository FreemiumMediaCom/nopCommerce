...
namespace FreemiumMedia.Nop.Plugin.ExternalAuth.LinkedIn
{
    public class LinkedInAuthenticationMethod : BasePlugin, IExternalAuthenticationMethod
    {
        ...
        {
            return LinkedInAuthenticationDefaults.VIEW_COMPONENT_NAME;
        }
        ...
        {
            //settings
            _settingService.SaveSetting(new LinkedInAuthenticationSettings());

            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("FreemiumMedia.Plugins.ExternalAuth.LinkedIn.ClientKeyIdentifier", "Client ID");
        ...
        {
            //settings
            _settingService.DeleteSetting<LinkedInAuthenticationSettings>();

            //locales
            _localizationService.DeletePluginLocaleResource("FreemiumMedia.Plugins.ExternalAuth.LinkedIn.ClientKeyIdentifier");

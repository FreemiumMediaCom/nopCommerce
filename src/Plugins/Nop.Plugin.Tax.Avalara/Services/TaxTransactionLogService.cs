...
namespace Nop.Plugin.Tax.Avalara.Services
{
    ...
    public class TaxTransactionLogService
    {
        ...
        public async virtual Task<TaxTransactionLog> GetTaxTransactionLogById(int logItemId)
        {
            if (logItemId == 0)
                return null;
        ...
        public async virtual Task InsertTaxTransactionLog(TaxTransactionLog logItem)
        {
            if (logItem == null)
        ...
        /// </summary>
        /// <param name="logItem">Log item</param>
        public async virtual Task UpdateTaxTransactionLog(TaxTransactionLog logItem)
        {
            if (logItem == null)
                throw new ArgumentNullException(nameof(logItem));
        ...
        /// </summary>
        /// <param name="logItem">Log item</param>
        public async virtual Task DeleteTaxTransactionLog(TaxTransactionLog logItem)
        {
            if (logItem == null)
                throw new ArgumentNullException(nameof(logItem));
        ...
        public async virtual Task DeleteTaxTransactionLog(int[] ids)
        {
            var log = _taxTransactionLogRepository.Table.Where(logItem => ids.Contains(logItem.Id));
            await _taxTransactionLogRepository.Delete(log);
        }

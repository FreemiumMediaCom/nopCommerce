...
{
    public class MeetupPlugin : BasePlugin, IMiscPlugin
    {
        #region Fields
        ...
        public MeetupPlugin(ILocalizationService localizationService,
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/Meetup/Configure";
        }
        ...
        {
            return MeetupDefaults.VIEW_COMPONENT_NAME;
        }
        ...
        public override void Install()
        {
            ...
            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("FreemiumMedia.Plugins.Misc.Meetup.Navigation", "Events/Meet-Ups");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResource("FreemiumMedia.Plugins.Misc.Meetup.Navigation");

...
namespace Nop.Services.Common
{
    ...
    public partial interface IAddressAttributeParser
    {
        ...
        Task<IList<string>> ParseValues(string attributesXml, int addressAttributeId);
        ...
        Task<string> AddAddressAttribute(string attributesXml, AddressAttribute attribute, string value);

...
namespace Nop.Services.Orders
{
    ...
    public partial class RewardPointService : IRewardPointService
    {
        ...
        protected async virtual Task<IQueryable<RewardPointsHistory>> GetRewardPointsQuery(int customerId, int? storeId, bool showNotActivated = false)
        {
        ...
        protected async virtual Task UpdateRewardPointsBalance(IQueryable<RewardPointsHistory> query)
        {
            //get expired points
        ...
        public async virtual Task<IPagedList<RewardPointsHistory>> GetRewardPointsHistory(int customerId = 0, int? storeId = null,
        ...
        public async virtual Task<int> GetRewardPointsBalance(int customerId, int storeId)
        {
        ...
        public async virtual Task<int> AddRewardPointsHistoryEntry(Customer customer, int points, int storeId, string message = "",
        ...
        public async virtual Task InsertRewardPointsHistoryEntry(RewardPointsHistory rewardPointsHistory)
        {
        ...
        /// </summary>
        /// <param name="rewardPointsHistory">Reward point history entry</param>
        public async virtual Task UpdateRewardPointsHistoryEntry(RewardPointsHistory rewardPointsHistory)
        {
            if (rewardPointsHistory == null)
                throw new ArgumentNullException(nameof(rewardPointsHistory));
        ...
        /// </summary>
        /// <param name="rewardPointsHistory">Reward point history entry</param>
        public async virtual Task DeleteRewardPointsHistoryEntry(RewardPointsHistory rewardPointsHistory)
        {
            if (rewardPointsHistory == null)
                throw new ArgumentNullException(nameof(rewardPointsHistory));

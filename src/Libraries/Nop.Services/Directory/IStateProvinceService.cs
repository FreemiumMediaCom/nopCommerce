...
namespace Nop.Services.Directory
{
    ...
    public partial interface IStateProvinceService
    {
        ...
        /// <returns>State/province</returns>
        Task<StateProvince> GetStateProvinceByAbbreviation(string abbreviation, int? countryId = null);
        ...
        Task<IList<StateProvince>> GetStateProvincesByCountryId(int countryId, int languageId = 0, bool showHidden = false);

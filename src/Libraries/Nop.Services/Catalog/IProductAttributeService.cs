...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeService
    {
        ...
        Task<int[]> GetNotExistingAttributes(int[] attributeId);
        ...
        Task<IList<ProductAttributeMapping>> GetProductAttributeMappingsByProductId(int productId);
        ...
        Task<IList<ProductAttributeValue>> GetProductAttributeValues(int productAttributeMappingId);
        ...
        Task DeletePredefinedProductAttributeValue(PredefinedProductAttributeValue ppav);
        ...
        /// <returns>Product attribute mapping collection</returns>
        Task<IList<PredefinedProductAttributeValue>> GetPredefinedProductAttributeValues(int productAttributeId);
        ...
        Task InsertPredefinedProductAttributeValue(PredefinedProductAttributeValue ppav);

        /// <summary>
        /// Updates the predefined product attribute value
        /// </summary>
        /// <param name="ppav">The predefined product attribute value</param>
        Task UpdatePredefinedProductAttributeValue(PredefinedProductAttributeValue ppav);
        ...
        Task<IList<ProductAttributeCombination>> GetAllProductAttributeCombinations(int productId);
        ...
        /// <returns>Product attribute combination</returns>
        Task<ProductAttributeCombination> GetProductAttributeCombinationBySku(string sku);
